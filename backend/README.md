...
## Project Structure
    ...
    ├── ten_dollar_planner_38627  # Django project configurations
...
1. Clone this repo and `cd ten_dollar_planner_38627`
...
2. Clone this repo and `cd ten_dollar_planner_38627`
